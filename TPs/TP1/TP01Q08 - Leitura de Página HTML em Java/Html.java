...
class Html {
    ...
    public static void countHtml(String s){
        ...
        for(int i = 0; i < resp.length(); i++){ 
            c = resp.charAt(i);
            if(resp.charAt(i) == '<' && resp.charAt(i+1) == 'b' && resp.charAt(i+2) == 'r' && resp.charAt(i+3) == '>')
                bre+=1;
            else if(resp.charAt(i) == '<' && resp.charAt(i+1) == 't' && resp.charAt(i+2) == 'a' && resp.charAt(i+3) == 'b' && resp.charAt(i+4) == 'l' && resp.charAt(i+5) == 'e' && resp.charAt(i+6) == '>')
                table+=1;
            else{ 
                if(c == 97){
                    x0+=1;
        ...
        MyIO.print("a(" + x0 + ") e(" + x1 + ") i(" + x2 + ") o(" + x3 + ") u(" + x4 + ") á(" + x5 + ") é(" + x6 + ") í(" + x7 + ") ó(" + x8 + ") ú(" 
