...
class Serie{
    ...
    public String removeTags(String line){
        ...
        //tratar string se houver espaco branco no inicio
        if(resp.charAt(0) == ' ') {
            for (int x = 1; x < resp.length(); x = x + 1) {
                    atributoTratado = atributoTratado + (char) resp.charAt(x);
            }//fim for
            return atributoTratado;
        }//fim if
